...
def tokenize_template(node_name: str) -> list[list | str]:
    """
...
def _join_template_args(idx: int, item: str | list[list | str], stream: TextIO):
    """
...
def join_template_tokens(tokens: list[list | str]) -> str:
    """
